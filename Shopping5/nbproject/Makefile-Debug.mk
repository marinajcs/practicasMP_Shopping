...
${TESTDIR}/tests/01.UnitDateTime.o: tests/01.UnitDateTime.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/01.UnitDateTime.o tests/01.UnitDateTime.cpp


${TESTDIR}/tests/02.UnitEvent.o: tests/02.UnitEvent.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/02.UnitEvent.o tests/02.UnitEvent.cpp


${TESTDIR}/tests/03.UnitEventSet.o: tests/03.UnitEventSet.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/03.UnitEventSet.o tests/03.UnitEventSet.cpp


${TESTDIR}/tests/04.UnitPair.o: tests/04.UnitPair.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/04.UnitPair.o tests/04.UnitPair.cpp


${TESTDIR}/tests/05.UnitIndex.o: tests/05.UnitIndex.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/05.UnitIndex.o tests/05.UnitIndex.cpp


${TESTDIR}/tests/10.Integration_WEEK_2.o: tests/10.Integration_WEEK_2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_WEEK_2.o tests/10.Integration_WEEK_2.cpp


${TESTDIR}/tests/10.Integration_WEEK_3.o: tests/10.Integration_WEEK_3.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -I. -I../googletest-master/googletest/include -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_WEEK_3.o tests/10.Integration_WEEK_3.cpp
...
${OBJECTDIR}/src/DateTime_nomain.o: ${OBJECTDIR}/src/DateTime.o src/DateTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DateTime_nomain.o src/DateTime.cpp;\
	else  \
...
${OBJECTDIR}/src/Event_nomain.o: ${OBJECTDIR}/src/Event.o src/Event.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Event_nomain.o src/Event.cpp;\
	else  \
...
${OBJECTDIR}/src/EventSet_nomain.o: ${OBJECTDIR}/src/EventSet.o src/EventSet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EventSet_nomain.o src/EventSet.cpp;\
	else  \
...
${OBJECTDIR}/src/Index_nomain.o: ${OBJECTDIR}/src/Index.o src/Index.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Index_nomain.o src/Index.cpp;\
	else  \
...
${OBJECTDIR}/src/Matrix_nomain.o: ${OBJECTDIR}/src/Matrix.o src/Matrix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Matrix_nomain.o src/Matrix.cpp;\
	else  \
...
${OBJECTDIR}/src/Pair_nomain.o: ${OBJECTDIR}/src/Pair.o src/Pair.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Pair_nomain.o src/Pair.cpp;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I../MPTest/include -I../googletest-master/googletest/include -I../DataTable/include -I../AnsiTerminal/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.cpp;\
	else  \
